...
export default function Contact() {
  ...
  return (
    <section id="contact" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="mt-16 space-y-10">
            ...
            >
              ...
              <div>
                ...
                <p className="text-white text-lg font-medium group-hover:text-primary transition-colors">toqiabdullah61990@gmail.com</p>
              </div>
            </a>
            <div className="group flex items-center gap-6 cursor-default w-fit">
              ...
              <div>
                ...
                <p className="text-white text-lg font-medium">Remote / Bangladesh</p>
              </div>
            </div>
          </div>
        </div>

        <div className="flex-1 bg-white/5 rounded-[2rem] p-8 md:p-12 border border-white/10 backdrop-blur-md relative">
          <AnimatePresence mode="wait">
            {!isSuccess ? (
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="bg-black/20 border border-white/5 rounded-2xl p-5 text-white placeholder:text-zinc-700 focus:outline-none focus:border-primary/50 transition-all"
                  />
                </div>
                <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="bg-black/20 border border-white/5 rounded-2xl p-5 text-white placeholder:text-zinc-700 focus:outline-none focus:border-primary/50 transition-all resize-none"
                  ></textarea>
                </div>
                <button
                  type="submit"
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-2 font-plus-jakarta">Message Sent!</h3>
                <p className="text-zinc-400">Thank you for reaching out. <br /> I will get back to you shortly.</p>
                <button
